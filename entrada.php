...
?>
    <main class="contenedor seccion contenido-centrado">
        ...
        <picture>
            ...
            <source srcset="build/img/destacada2jpg" type="img jepg">
            <img loading="lazy" src="build/img/destacada2.jpg" alt="img">
        </picture>
        
        <p class="informacion-meta">Escrito el: <span>24/02/26</span> Por: <span>Admin</span></p>
